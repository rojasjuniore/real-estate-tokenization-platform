...
export function ExploreSection() {
  ...
  const handlePropertyClick = (property: Property) => {
    ...
    const storeProperty = {
      ...
      pricePerToken: parseFloat(property.pricePerFraction),
      totalTokens: property.totalFractions,
      availableTokens: property.availableFractions,
      expectedYield: parseFloat(property.estimatedROI),
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="text-2xl font-bold text-primary-600 tracking-tight">{brandConfig.identity.companyName.toUpperCase()}</span>
            </div>
        ...
        <div className="flex justify-end">
          <div className="relative w-full max-w-sm">
            <input
              ...
              placeholder=""
              className="w-full h-10 pl-4 pr-12 rounded-full bg-[#DBE1E6]/50 border-none text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary-600/30"
            />
            <div className="absolute right-4 top-1/2 -translate-y-1/2">
              <IconBuscar size={18} color={brandConfig.colors.primary[600]} />
            </div>
          </div>
        </div>
      </div>
              ...
              featuredProperties.map((property, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 p-6 text-white">
                    <h2 className="text-3xl lg:text-4xl font-bold mb-1 leading-tight">
                ...
                <div className="p-3">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-primary-600 text-sm">
                      {parseFloat(property.pricePerFraction).toLocaleString()} USD
                    </span>
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
